...
class FileUploadService:
    ...
    async def upload_file(
        ...
        if not self.s3_client:
            raise HTTPException(
                status_code=500, detail="File upload service not available"
            )
        ...
        try:
            ...
            # Generate public URL
            public_url = (
                f"{settings.r2_endpoint_url}/{settings.r2_bucket_name}/{object_key}"
            )
    ...
    async def delete_file(self, file_url: str) -> bool:
        ...
        try:
            ...
            # Delete object
            self.s3_client.delete_object(Bucket=settings.r2_bucket_name, Key=object_key)
