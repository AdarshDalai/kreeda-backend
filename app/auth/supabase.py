...
# Auth Functions
async def sign_up_with_email_password(email: str, password: str, user_metadata: Optional[Dict] = None) -> Dict[str, Any]:
...
async def sign_in_with_oauth(provider: str, redirect_to: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        if response and response.user:
            return {
                ...
                "phone_confirmed_at": getattr(response.user, 'phone_confirmed_at', None),
                "user_metadata": response.user.user_metadata,
...
async def update_user(access_token: str, user_attributes: Dict[str, Any]) -> Dict[str, Any]:
...
async def reset_password_for_email(email: str, redirect_to: Optional[str] = None) -> Dict[str, Any]:
