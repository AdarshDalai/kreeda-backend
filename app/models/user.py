...
class Team(Base):
    ...
    captain = relationship("User", foreign_keys=[captain_id], back_populates="captained_teams")
    members = relationship("TeamMember", back_populates="team")
    home_matches = relationship("CricketMatch", foreign_keys="CricketMatch.team_a_id", back_populates="team_a")
    away_matches = relationship("CricketMatch", foreign_keys="CricketMatch.team_b_id", back_populates="team_b")
